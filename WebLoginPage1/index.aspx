<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="WebLoginPage1.index" %>
            ...
            <div class="w3l-form-info">
                <div class="w3_info">
                    ...
                    <form action="#" method="post" runat="server">
                        ...
                        <asp:Button ID="BtnLogin" runat="server" class="btn btn-primary btn-block" Text="Login" /> 
                    </form>
